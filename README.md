...
The dataset used is the **Retina Blood Vessel Segmentation** dataset, available on [Kaggle](https://www.kaggle.com/). It contains paired retinal images and their corresponding binary vessel masks.
...
This project uses [`segmentation-models-pytorch`](https://github.com/qubvel/segmentation_models.pytorch) to build a **U-Net** with a **ResNet-50 encoder** pretrained on ImageNet.
